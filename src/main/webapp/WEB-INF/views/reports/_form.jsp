...
<a>出勤時間</a><input type="time" name="${AttributeConst.REP_COL_ATTENDANCE_AT_WORK.getValue()}" value="${report.attendance_at_work}" />
<a>退勤時間</a><input type="time" name="${AttributeConst.REP_COL_LEAVING_WORK.getValue()}" value="${report.leaving_work}" />
